  ...
  return {
    data: [
      ...
      },
      {
        ...
        id: 'f1684f28-63bb-4b52-bb20-437ad1033838',
        traveledWith: 'FAMILY',
        entryDate: 1251112963853,
        travelDate: 1249084800000,
        ratings: {
          general: {
            general: 9
        ...
        titles: {
          'nl-be': 'mega super mooie camping met veel te doen'
        },
        texts: {
          'nl-be':
            'Camping Pra delle tori is een mega mooie camping voor zowel jong als oud wat te doen .. \nWe hebben weinig last van muggen gehad dit komt omdat ze 2x per week een wagen laten rijden voor de bestrijding ervan.\nAlleen jammer van deze camping dat het een beetje veraf van een gezellig dorpje ligt!'
        },
        user: 'Marcel',
        locale: 'nl-be'
      }
